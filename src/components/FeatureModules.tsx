...
const FeatureModules = ({ vehicleType }: FeatureModulesProps) => {
  ...
  const renderModule = (module: any, index: number) => {
    ...
    const baseClasses = "group bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-500 hover:bg-white/15 text-center animate-fade-in hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20 transform-gpu relative overflow-hidden min-h-[120px] flex flex-col justify-center"
